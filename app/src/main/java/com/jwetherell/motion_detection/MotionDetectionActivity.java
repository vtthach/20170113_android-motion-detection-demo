...
public class MotionDetectionActivity extends SensorsActivity {
    ...
    private IMotionDetection rgbMotionDetection = new RgbMotionDetection();
    private IMotionDetection lumaMotionDetection = new LumaMotionDetection();
    private IMotionDetection aggregateLumaMotionDetection = new AggregateLumaMotionDetection();
    public static final Handler handler = new Handler();
    private static Toast toast;
    private static Runnable mRunnablePostToast = new Runnable() {
        @Override
        public void run() {
            toast.setText(detector.getClass().getSimpleName() +" - Movement detect!");
            toast.show();
        }
    };
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (Preferences.USE_RGB) {
            detector = rgbMotionDetection;
        } else if (Preferences.USE_LUMA) {
            detector = lumaMotionDetection;
        } else {
            // Using State based (aggregate map)
            detector = aggregateLumaMotionDetection;
        }
        addView();
        toast = Toast.makeText(this, "Movement detect", Toast.LENGTH_SHORT);
    }

    private void addView() {
        View view = LayoutInflater.from(this).inflate(R.layout.view_detector_mode, (ViewGroup) findViewById(android.R.id.content), true);
        view.findViewById(R.id.LumaMotionDetection).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                detector = lumaMotionDetection;
            }
        });
        view.findViewById(R.id.AggregateLumaMotionDetection).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                detector = aggregateLumaMotionDetection;
            }
        });
        view.findViewById(R.id.RgbMotionDetection).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                detector = rgbMotionDetection;
            }
    ...
    private SurfaceHolder.Callback surfaceCallback = new SurfaceHolder.Callback() {
        ...
        public void surfaceCreated(SurfaceHolder holder) {
            try {
                ...
                Log.e("PreviewDemo-surfaceCB", "Exception in setPreviewDisplay()", t);
            }
        }
        ...
        public void run() {
            ...
            try {
                ...
                if (img != null && detector.detect(img, width, height)) {
                    handler.post(mRunnablePostToast);
    ...
    private static final class SavePhotoTask extends AsyncTask<Bitmap, Integer, Integer> {
        ...
        private void save(String name, Bitmap bitmap) {
            File photo = new File(Environment.getExternalStorageDirectory() + "/vtt", name + ".jpg");
